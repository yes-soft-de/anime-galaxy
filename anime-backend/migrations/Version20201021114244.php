 ...
 */
final class Version20201021114244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE episode (id INT AUTO_INCREMENT NOT NULL, anime_id INT NOT NULL, season_number INT NOT NULL, episode_number INT NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, duration TIME DEFAULT NULL, publish_date DATE DEFAULT NULL, created_at DATE NOT NULL, special_link TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE anime (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, main_image VARCHAR(255) NOT NULL, category_id INT NOT NULL, creation_date DATE DEFAULT NULL, special_link TINYINT(1) DEFAULT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
