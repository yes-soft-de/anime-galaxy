 ...
 */
final class Version20210109155541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE anime (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, main_image VARCHAR(255) NOT NULL, categories JSON NOT NULL, creation_date DATE DEFAULT NULL, special_link TINYINT(1) DEFAULT NULL, description LONGTEXT NOT NULL, publish_date DATE DEFAULT NULL, episodes_count INT DEFAULT NULL, trailer_video VARCHAR(500) DEFAULT NULL, suggest TINYINT(1) DEFAULT \'0\' NOT NULL, general_rating VARCHAR(50) DEFAULT NULL, age_group VARCHAR(50) DEFAULT NULL, poster_image VARCHAR(255) DEFAULT NULL, poster_special_link TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE episode (id INT AUTO_INCREMENT NOT NULL, anime_id INT NOT NULL, season_number INT NOT NULL, episode_number INT NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, duration TIME DEFAULT NULL, publish_date DATE DEFAULT NULL, created_at DATE NOT NULL, special_link TINYINT(1) DEFAULT NULL, categories JSON NOT NULL, poster_image VARCHAR(255) DEFAULT NULL, poster_special_link TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_profile (id INT AUTO_INCREMENT NOT NULL, user_id VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, story LONGTEXT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, cover_special_link TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
