  ...
  static InputDecoration getInputDecorationDay(
    ...
    return InputDecoration(
      ...
      focusedBorder: getOutLineBorder(
          width: 1, color: ProjectColors.bgIconDay, radius: 30),
      enabledBorder: getOutLineBorder(
          width: 1.5, color: ProjectColors.bgIconDay, radius: 30),
      errorBorder: getOutLineBorder(
          width: 1.5, color: ProjectColors.bgError, radius: 30),
