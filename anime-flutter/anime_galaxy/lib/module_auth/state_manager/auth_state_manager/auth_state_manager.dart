...
class AuthStateManager {
  ...
  void register(RegisterRequest request){
    _authService.register(request).then((value){
      if(value == null || value == false){
        Fluttertoast.showToast(msg: S.current.errorHappened);
        _stateSubject.add(RegisterStateError());
      }else{
        _stateSubject.add(RegisterStateSuccess());
      }
    });
  }

  void login(LoginRequest request){
    _authService.login(request).then((value){
      if(value == null || value == false){
        Fluttertoast.showToast(msg: S.current.errorHappened);
        _stateSubject.add(LoginStateError());
      }else{
