    ...
    return
      AppBar(
        ...
        <Widget>[
          GestureDetector(
              onTap: (){
                Navigator.pushNamed(drawerKey.currentContext, NotificationRoutes.ROUTE_NOTIFICATION_SCREEN);
              },
